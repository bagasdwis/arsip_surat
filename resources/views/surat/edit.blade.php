        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h1 class="h1 text-white d-inline-block mb-0">Arsip Surat >> Edit</h1>
              ...
              <form action="{{ route('surat.update', $surat->id ) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      @foreach($kategori as $result)
                          ...
                          @if($result->id == $surat->kategori_id)
                            selected
                          @endif
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="file" class="custom-file-input" id="validatedCustomFile" name="file_surat" value="{{ $surat->file_surat }}">
